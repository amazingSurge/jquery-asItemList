...
(function(global, factory) {
...
})(this, function(_jquery, _Sortable) {
  'use strict';
  ...
  var asItemList = (function() {
    function asItemList(element, options) {
      ...
      this.strings = _jquery2.default.extend(
        {},
        STRINGS[this.lang],
      ...
      this.$itemList = (0, _jquery2.default)(
        this.options
          .itemList()
          .replace(/namespace/g, this.namespace)
          .replace(/\{\{strings.addTitle\}\}/g, this.strings.addTitle)
          .replace(/\{\{strings.prompt\}\}/g, this.strings.prompt)
      );
      ...
      [
            ...
            this.$list
              .on(
                ...
                _jquery2.default.proxy(function(e) {
                  this.editIndex = (0, _jquery2.default)(
                    e.currentTarget
                  ).index();
              ...
              .on(
                ...
                'li',
                _jquery2.default.proxy(function(e) {
                  (0, _jquery2.default)(e.currentTarget).addClass(
                    this.classes.hover
                  );
                }, this)
              )
              ...
              .on(
                'mouseenter',
                '.' + this.namespace + '-list-drag',
                _jquery2.default.proxy(function(e) {
                  this.sortIndex = (0, _jquery2.default)(e.currentTarget)
                    .parent()
                    .index();
                  this.sort = new _Sortable2.default(list, {
                    onUpdate: function onUpdate(evt) {
                      ...
                      that.value.splice(
                        (0, _jquery2.default)(evt.item).index(),
                        0,
                        value[0]
                      );
              ...
              .on(
                'click',
                '.' + this.namespace + '-list-remove',
                _jquery2.default.proxy(function(e) {
                  this.indexed = (0, _jquery2.default)(e.currentTarget)
                    .parent()
                    .index();
        ...
        },
        {
          ...
          value: function _updateList() {
            if (this.value.length > this.$list.children().length) {
              ...
              this.value.length === this.$list.children().length &&
              this.value.length !== 0
            ) {
        ...
        },
        {
          ...
          value: function _addList() {
            ...
            for (
              var i = this.$list.children().length, item;
              i < this.value.length;
              i++
            ) {
              item = this.value[i];
